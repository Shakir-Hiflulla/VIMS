...
<body>
    ...
    <main>
        <div class="main_div">
            <h1>About Us</h1>
            <p>Auto Guard is more than just an insurance company; we're your trusted partner in safeguarding what matters most. Our mission is clear: to offer comprehensive and affordable insurance solutions that provide peace of mind to every driver. With a steadfast commitment to integrity, customer-centricity, innovation, and reliability, we deliver unparalleled protection and exceptional service to our valued customers. From comprehensive coverage options to competitive rates and exceptional claims satisfaction, Auto Guard is here to support you every step of the way. Join us today and experience the difference that superior coverage and unwavering support can make for your peace of mind on the road.</p>
            <div class="img"><img src="image/about.jpeg" alt="picture" id="about_pic"></div>
        </div>
    </main>
    <footer>
