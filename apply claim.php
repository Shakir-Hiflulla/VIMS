    ...
    <main>
        <div class="SignUp_div">
            <form method="post" action="claim valid.php">
                ...
                <input type="text" name="pol_no" placeholder="Policy No" required><br>
                <input type="text" name="location" placeholder="Location" required><br>
                <label for="date">Incident Date:</label><br>
                <input type="date" name="date" required><br>
                <textarea name="details" cols="50" rows="10" placeholder="Describe the incident" required></textarea><br>
