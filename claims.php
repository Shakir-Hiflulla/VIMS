...
<body>
    ...
    <div class="agent_div">
            ...
            <?php
                ...
                if (isset($_SESSION['id'])){
                $id=$_SESSION['id'];
                $sql = "SELECT * FROM claim WHERE user_id=$id";
                $result = $con->query($sql);
                echo '<table id="Claim_table">
                <tr>
                    <th>No</th>
                ...
                if ($result->num_rows > 0){
                    ...
                    {
                        echo "<tr>";
                        echo "<td>".$row['claim_id']."</td><td>".$row['date']."</td><td>".$row['apply_date']."</td><td>".$row['details']."</td><td>".$row['status']."</td>";
                        echo "</tr>";
                        
                    }
                   
                }
                echo '</table><br><br><form method ="post" action="apply claim.php">
                <input type="submit" name="add" value="Apply for Claim">
            </form>';
                ...
                if ($result->num_rows > 0){
                    ...
                    {
                        echo "<tr>";
                        echo '<td>'.$row['claim_id'].'</td><td>'.$row['date'].'</td><td>'.$row['apply_date'].'</td><td>'.$row['details'].'</td><td>'.$row['status'].'</td><td>
                        <form method="post" action="claim valid.php">
                            <input type="hidden" name="c_id" value="'.$row['claim_id'].'">
