    ...
    <main>
        <div class="agent_div">
            ...
            <?php
                ...
                echo ' <h1>FAQs</h1><table id="faqs_table">
                <tr>
                    <th>Questions</th>
                    <th>Response</th>
                    <th>EMAIL</th>
                ...
                if ($result->num_rows > 0){
                    ...
                    {
                        echo "<tr>";
                        echo '<td>'.$row['question'].'</td><td>'.$row['response'].'</td><td>'.$row['email'].'</td><td>
                        <form method="post" action="contact.php">
                            <input type="hidden" name="rspns" value="'.$row['faq_id'].'">
                ...
                $result = $con->query($sql);
                echo ' <h1>Quotes</h1><table id="faqs_table">
                <tr>
                    <th>Questions</th>
                    <th>Name</th>
                    <th>Email</th>
                ...
                if ($result->num_rows > 0){
                    ...
                    {
                        echo "<tr>";
                        echo '<td>'.$row['question'].'</td><td>'.$row['name'].'</td><td>'.$row['email'].'</td><td>
                        <form method="post" action="contact.php">
                        <input type="hidden" name="qid" value="'.$row['quote_id'].'">
