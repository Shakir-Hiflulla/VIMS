...
<body>
    ...
    if(isset($_SESSION['id'])){
        ...
        <a href="#"><img src="image/profile.jpeg" alt="profile" id="profile_pic"></a>
        <div id="menu_iconn">
            <p><i class="fa-solid fa-bars" onclick="toggleDropdown()"></i></p>
        </div>
    </nav>';
    ...
    <main>
        <div class="login_div">
            <form action="user validate.php" method="post">
                <h1>Login</h1>
            ...
            <hr>
            <p>Haven't any account?<a href="Sign up.php"> Sign Up</a></p>
        </div>
    </main>
    <footer>
